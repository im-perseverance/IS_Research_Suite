...
# best validator via take_map: hkB wins (per-stake emission 1e-6 vs 8e-7,
# 2.155 net after 18% take beats hkA's 1.913 after 9%)
raw_b = 0.002/2000*sa.BLOCKS_PER_YEAR
assert abs(R[10]["best_validator_apy"] - raw_b*0.82) < 1e-9
